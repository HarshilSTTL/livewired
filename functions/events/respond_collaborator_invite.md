...
### v1 (Deprecated)
- **Function name:** `respond_collaborator_invite`
- **Endpoint:** `POST /rpc/respond_collaborator_invite`
- Re-checked a 5-collaborator limit before accepting.
...
```sql
-- Function: respond_collaborator_invite_v2
-- Group:    Events
-- Endpoint: POST /rpc/respond_collaborator_invite_v2
...
CREATE OR REPLACE FUNCTION respond_collaborator_invite_v2(
    p_event_id   uuid,
    p_profile_id uuid,
    p_user_id    uuid,
