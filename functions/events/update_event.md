...
### v2.6 (Current — 2026-09-14) ✅
- **Function name:** `update_event_v2_6`
...
## V2.6 Function (Current) ✅

```sql
-- Function: update_event_v2_6
-- Group: Events
-- Endpoint: POST /rpc/update_event_v2_6
...
--
-- DEPLOYMENT — this is a NEW function name (update_event_v2_6), no overload to drop.
-- Old callers on update_event_v2_5 keep working unchanged (see "V2.4 Function (Previous)" below).
-- Point the client at /rpc/update_event_v2_6 once deployed, then:
--   NOTIFY pgrst, 'reload schema';
--
-- 2026-08-21 in-place patch: same signature, CREATE OR REPLACE over the existing
-- update_event_v2_6 — no new endpoint, no client-side change, just redeploy this SQL
...
--
CREATE OR REPLACE FUNCTION update_event_v2_6(
    p_event_id             uuid,
    p_user_id              uuid,
