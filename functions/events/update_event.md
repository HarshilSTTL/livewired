...
--
-- DEPLOYMENT — this is a NEW function name (update_event_v2_4), no overload to drop.
-- Old callers on update_event_v2_3 keep working unchanged (see "V2.3 Function (Previous)" below).
-- Point the client at /rpc/update_event_v2_4 once deployed, then:
