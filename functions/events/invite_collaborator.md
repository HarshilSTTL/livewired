...
- **Function name:** `invite_collaborator_v2`
- **Endpoint:** `POST /rpc/invite_collaborator_v2` `[DEPRECATED]`
- **Change from v1:** Raises the accepted-collaborator cap from 5 to 9
  (`max_collaborators_per_event`). No other behavior changes.
- Still not the primary invite mechanism — see the DEPRECATED note below.

### v1 (Deprecated)
- **Function name:** `invite_collaborator`
- **Endpoint:** `POST /rpc/invite_collaborator`
- Max 5 accepted collaborators per event.
...
```sql
-- Function: invite_collaborator_v2
-- Group:    Events
-- Endpoint: POST /rpc/invite_collaborator_v2  [DEPRECATED]
...
CREATE OR REPLACE FUNCTION invite_collaborator_v2(
    p_event_id                uuid,
